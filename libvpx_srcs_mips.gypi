...

{
  'sources': [
    ...
    '<(libvpx_source)/vp9/common/vp9_common_types.h',
    ...
    '<(libvpx_source)/vp9/common/vp9_onyxd.h',
    ...
    '<(libvpx_source)/vp9/common/vp9_type_aliases.h',
