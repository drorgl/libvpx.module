...

{
  'sources': [
    ...
    '<(libvpx_source)/vp9/encoder/vp9_psnr.c',
    '<(libvpx_source)/vp9/encoder/vp9_psnr.h',
    ...
    '<(libvpx_source)/vp9/encoder/vp9_sad_c.c',
    ...
    '<(libvpx_source)/vp9/encoder/vp9_variance_c.c',
